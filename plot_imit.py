...
root_dir = '/Users/cooper/Downloads/PromptSep/audios/imit_cond'
sample_list = [['real_0_mix', 'real_0_mix', 'beijing vlog', 
                'beijing vlog', 'minions', 'nyc_walk_1', 
                'Prometheus_mono', 'Prometheus_mono',
                'real_2_mix', 'real_2_mix'], 
               ['fireworks_imitation_hissing', 'fireworks_woman_imitation', 'beijing vlog imit 1',
                'beijing vlog imit 2', 'minions_imit_1', 'nyc_walk_1_imit_1',
                'pr_imit_1', 'pr_imit_2', 'real_2_imit_1', 'real_2_mix_imit_2'],
               ['hissing', 'shouting', 'beijing vlog imit pred 1', 
                'beijing vlog imit 2 pred', 'minions_imit_pred_1', 'nyc_walk_1_imit_pred_1', 
                'pr_imit_pred_1', 'pr_imit_pred_2', 'real_2_imit_pred_1', 'real_2_mix_imit_pred_2']]
row_content = []
sample_rate = 44100
...
row_header = ['Mixture', 'Vocal Imitation', 'PromptSep (ours)']
...
sg = soundgrid(*row_content, sr=sample_rate, r_header=row_header, c_header=[], show='stft')

with open('hearme_imit.html', 'w') as f:
    f.write(sg)