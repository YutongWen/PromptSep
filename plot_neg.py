...
root_dir = '/Users/cooper/Downloads/PromptSep/audios/neg_text_cond'
sample_list = [['real_0_mix', 'real_0_mix', 'real_2_mix', 
                'Prometheus_mono', 'Prometheus_mono', 'minions', 
                'nyc_walk_1', 'nyc_walk_1', 'beijing vlog', 'beijing vlog'], 
               ['no fireworks', 'remove woman shouting', 'remove music and speech', 
                'remove speech', 'remove drum beats', 'i dont want explosion', 
                'neglect speech', 'neglect street ambiance', 'no background music', 'no mouse clicking']]
row_content = []
sample_rate = 44100
...
c_header = ['No fireworks', 'Remove woman shouting', 'Remove music and speech', 
            'Remove speech', 'Remove drum beats', 'I don\'t want explosion', 
            'Neglect speech', 'Neglect street ambiance',
            'No background music', 'No mouse clicking']
...
with open('hearme_neg.html', 'w') as f:
    f.write(sg)